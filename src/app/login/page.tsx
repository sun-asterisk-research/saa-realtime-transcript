    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-b from-slate-900 to-slate-800 p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-slate-400">Sign in to access translation sessions</p>
        </div>
        ...
        <div className="bg-slate-800/50 rounded-lg p-8 border border-slate-700">
          ...
          <Button
            ...
            disabled={isLoading}
            className="w-full h-12 bg-white hover:bg-gray-100 text-slate-900 border-0 flex items-center justify-center gap-3">
