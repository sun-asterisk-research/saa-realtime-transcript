-- Migration: Seed Default Public Context Sets
-- This migration is safe to re-run (idempotent)
-- Automatically executed with `supabase db push`

-- ============================================================================
-- CLEANUP: Delete existing default context sets (if any)
-- ============================================================================

DELETE FROM context_set_translation_terms WHERE context_set_id IN (
...
DELETE FROM context_set_general WHERE context_set_id IN (
  '00000000-0000-0000-0000-000000000001',
  '00000000-0000-0000-0000-000000000002',
  '00000000-0000-0000-0000-000000000003',
  '00000000-0000-0000-0000-000000000004'
...
DELETE FROM context_set_terms WHERE context_set_id IN (
  '00000000-0000-0000-0000-000000000001',
  '00000000-0000-0000-0000-000000000002',
  '00000000-0000-0000-0000-000000000003',
  '00000000-0000-0000-0000-000000000004'
...
DELETE FROM context_sets WHERE id IN (
  '00000000-0000-0000-0000-000000000001',
  '00000000-0000-0000-0000-000000000002',
  '00000000-0000-0000-0000-000000000003',
  '00000000-0000-0000-0000-000000000004'
